export const ShipmentQueries = {
    ...
    findByReferenceId: `
        SELECT 
            s.type, s.referenceId, o.code as organizationCode, o.id as organizationId, 
            o.type as organizationType, s.estimatedTimeArrival, s.weight, s.weightUnit FROM shipments s
